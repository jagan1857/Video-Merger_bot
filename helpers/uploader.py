        ...
        if (await db.get_upload_as_doc(cb.from_user.id)) is False:
            ...
            sent_ = await bot.send_video(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [InlineKeyboardButton("👨‍💻 ∂єνєℓσρєя 👨‍💻", url="https://t.me/MR_JAGANMOHAN")],
                        [InlineKeyboardButton("⭕ ѕυρρσят ⭕", url="https://t.me/+cTsBLwDFiE44NzY1"),
                         InlineKeyboardButton("⭕ ¢нαηηєℓ ⭕", url="https://t.me/My_Test_Botz")]
                    ]
                )
            )
        else:
